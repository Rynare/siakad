    ...
    <div class="card col-4" style="height: 700px; border-radius: 25px;">
        <div class="card-body d-flex flex-column justify-content-between">
            <div class="text-center mb-3">
                <img class=" rounded-4" src="{{ asset('assets/img/c.jpg')}}" style="width: 100%;" alt="Deskripsi Gambar">
            </div>
                <h5 class="mt-3 text-capitalize text-center" style="color: black; font-size: 30px; font-family: Kanit; font-weight: 700; word-wrap: break-word;">DATA RUANG</h5>
            <div class="text-end">
    ...
    <div class="card col-4" style="height: 700px; border-radius: 25px;">
        <div class="card-body d-flex flex-column justify-content-between">
            <div class="text-center mb-3">
                ...
                <h5 class="mt-3 text-capitalize text-center" style="color: black; font-size: 30px; font-family: Kanit; font-weight: 700; word-wrap: break-word;">DATA BARANG</h5>
            <div class="text-end">
