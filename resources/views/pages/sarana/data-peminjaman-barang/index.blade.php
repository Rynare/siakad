            ...
            <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive pb-2 px-3">
                        ...
                        <a href="/data-peminjaman-barang-history" type="submit" id="btntambah"
                                    ...
                                    <tr data-id="{{ $value->id }}">
                                        ...
                                        <td class="text-center">
                                            <button type="button" onclick="showUpdateModalDialog(this)" data-bs-toggle="modal" data-bs-target="#update-modal"
                                                ...
                                                tgl-pengembalian="{{ $value->tanggal_pengembalian }}" class="btn btn-warning font-weight-bold btn--edit text-sm rounded-circle"
                            ...
                            <div class="modal-dialog  modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="modal-edit-form" action="{{ route('peminjamanBarang.update') }}" class="row g-3 py-1 px-4" method="POST"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="jumlah"
                                                        ...
                                                        value=""
                                                        {{ $errors->has('jumlah') ? 'autofocus="true"' : '' }}>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">Tanggal peminjaman</label>
                                                <div class="input-group">
                                                    <input type="date" name="tanggal_peminjaman" class="form-control rounded-3"
                                                        id="inputEmail4" required value=""
                                                        {{ $errors->has('tanggal_peminjaman') ? 'autofocus="true"' : '' }}>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">Tanggal pengembalian</label>
                                                <div class="input-group">
                                                    <input type="date" name="tanggal_pengembalian" class="form-control rounded-3"
                                                        id="inputEmail4" required value=""
                                    ...
                                    <div class="modal-body">
                                        <form action="/peminjaman-store" class="row g-3 py-1 px-4" method="POST"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" name="tanggal_peminjaman" class="form-control rounded-3"
                                                        id="inputEmail4" required value="{{ old('tanggal_peminjaman') }}"
                                                        {{ $errors->has('tanggal_peminjaman') ? 'autofocus="true"' : '' }}>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
