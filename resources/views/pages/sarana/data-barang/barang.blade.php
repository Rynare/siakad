                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('update-barang', $barang->id) }}" class="btn btn-primary">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="{{ route('hapus-barang', $barang->id) }}" onclick="return confirm('Anda yakin akan menghapus data ini?')" class="btn btn-danger ">
